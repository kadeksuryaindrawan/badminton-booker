                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="jam_buka" placeholder="Example: 08.00" value="{{ old('jam_buka') }}" required>
                                            @error('jam_buka')
                                                <p class="text-danger text-sm">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="jam_tutup" placeholder="Example: 17.00" value="{{ old('jam_tutup') }}" required>
                                            @error('jam_tutup')
                                                <p class="text-danger text-sm">{{ $message }}</p>
                                            @enderror
                                        </div>
