...
class ExportAllExcel implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    /**
    ...
    */
    public function collection()
    {
        if (Auth::user()->role == 'super admin') {
            return Pemesanan::where('transaction_status', 'terbayar')->orderBy('created_at', 'desc')->get();
        } else {
            return Pemesanan::where('transaction_status', 'terbayar')->where('admin_id', Auth::user()->id)->orderBy('created_at', 'desc')->get();
        }
    }
